...
namespace Neat.Data.Schema
{
    /// <summary>
    /// Tools to manage DbParameters 
    /// </summary>
    internal partial class DbParameters
    {
        /// <summary>
        ...
        public static void AddValues<T, V>(DbParameterCollection parameters, T values) where V : DbParameter, new()
        {
            ...
            AddOrReplaceParameters(parameters, properties);
        }
        ...
        public static void AddValues<T>(DbCommand command, T values)
        {
            ...
            AddOrReplaceParameters(command.Parameters, properties);
        }
            ...
            else
            {
                ...
                foreach (PropertyInfo property in typeof(T).GetProperties())
                {
                    if (TypeExtension.IsPrimitive(property.PropertyType))
                    {
                        ...
                        // Parameter name
                        //string attribute = Neat.Data.Annotations.ColumnAttribute.GetColumnAttributeName(property);
        ...
        private static void AddOrReplaceParameters(DbParameterCollection existingParameters, IEnumerable<DbParameter> newParameters)
        {
            string prefix = DbParameters.GetPrefixParameter(existingParameters);
